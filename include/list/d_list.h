...
bool_t d_list__is_empty(d_list_t const *list)
{
  return s_list__is_empty(&list->_super);
}

bool_t d_list__include(d_list_t const *list, d_list_item_t const *item)
{
  return s_list__include(&list->_super, (s_list_item_t const *) item);
}

d_list_item_t *d_list__first(d_list_t const *list)
{
  return (d_list_item_t *) s_list__first(&list->_super);
}

d_list_item_t *d_list__last(d_list_t const *list)
{
...
size_t d_list__length(d_list_t const *list)
{
